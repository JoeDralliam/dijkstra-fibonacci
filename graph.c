...
edge_t* edge_create(size_t vertex, size_t weight)
{
...
void graph_add_edge(graph_t* graph, size_t v1, size_t v2, size_t w)
{
    edge_list* eList1 = array_get(graph, v1);
    edge_list* eList2 = array_get(graph, v2);
    
    array_push_back(eList1, (void*)edge_create(v2, w));
    array_push_back(eList2, (void*)edge_create(v1, w));
}
